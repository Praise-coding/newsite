    ...
    return (
        <div className="container">
            <div className="header">
                ...
                <p> {validData ? codeSubmitted ? (isVerified == '0' ? message : "Code is being verified") : message : "We'll send a verification code to your phone number to secure your account"}</p>
            </div>
