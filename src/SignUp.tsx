    ...
    return (
        <div className="container">
            <div className="header">
                ...
                <h1>{validData ? (!codeSubmitted ? "Authenticate with code" : (message == "Phone number has been verified" ? "Verified Successfully": "Verification In Progress")) : "Verify With Phone Number"}</h1>
